...
function SkillChip({ skill }: { skill: string }) {
  return (
    <span className="px-3 py-1.5 rounded-lg text-sm text-gray-300 bg-white/5 border border-white/8 hover:border-blue-500/20 hover:text-blue-300 hover:bg-blue-500/5 transition-all duration-200 cursor-default">
      {skill}
    </span>
  );
}
...
export default function Skills() {
  ...
  return (
    <section id="skills" className="py-24 lg:py-32 relative bg-[#080c14]">
