...
export default function Experience() {
  ...
  return (
    <section id="experience" className="py-24 lg:py-32 relative bg-white dark:bg-[#0B0F19]">
              ...
              >
                ...
                <div className="glass rounded-3xl p-6 md:p-8 border border-white/10 hover:border-blue-500/20 transition-colors duration-300">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
                    ...
                    <span className="px-3 py-1.5 rounded-lg glass border border-white/10 text-sm text-slate-600 dark:text-gray-400 whitespace-nowrap self-start">
                      {exp.period}
                    </span>
                  </div>

                  <p className="text-slate-600 dark:text-gray-400 text-sm leading-relaxed mb-6">{exp.description}</p>

                  {/* Grid: Responsibilities + Achievements */}
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                      <h4 className="text-xs font-semibold text-slate-500 dark:text-gray-500 uppercase tracking-widest mb-3">
                        Responsibilities
                      </h4>
                      <ul className="flex flex-col gap-2">
                        {exp.responsibilities.map((r, ri) => (
                          <li key={ri} className="flex items-start gap-2 text-sm text-slate-600 dark:text-gray-400">
                    ...
                    <div>
                      ...
                      <ul className="flex flex-col gap-2">
                        {exp.achievements.map((a, ai) => (
                          <li key={ai} className="flex items-start gap-2 text-sm text-slate-700 dark:text-gray-300 font-medium">
